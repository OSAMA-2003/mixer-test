        ...
        <div className="grid items-center gap-14 lg:grid-cols-12 lg:gap-16">
          ...
          >
            ...
            <div className="mt-8 flex flex-wrap items-center gap-5">
              ...
              <a
                href="#branches"
                className="group inline-flex items-center gap-3 rounded-2xl bg-[#171717] px-7 py-4 text-sm font-black text-white shadow-xl transition-all duration-300 hover:-translate-y-1 hover:bg-black hover:shadow-2xl"
              >
